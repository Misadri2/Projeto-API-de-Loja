       ...
       : base(options)
        ...
        {   base.OnModelCreating(modelBuilder);
            ...
            var estoque = new[]{
              ...
              new Estoque {IdEstoque=2, ProdutoEstoque="Fanta", QuantidadeEstoque=150},
          };  
            ...
            modelBuilder.Entity<Produto>().HasData(new { IdProduto=2, Descricao="Fanta", Unidade="UN", EstoqueId=2});
            modelBuilder.Entity<Produto>().HasData(new { IdProduto=3, Descricao="FantaUva", Unidade="UN", EstoqueId=2});
